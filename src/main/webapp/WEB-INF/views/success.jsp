<%@ page language="java" contentType="text/html; charset=EUC-KR"
    ...
    <div class="flex-column align-center confirm-success w-100 max-w-540">
      ...
      <div class="w-100 button-group">
        <a class="btn primary" href='https://app.tosspayments.com/signin?redirectUrl=https%3A%2F%2Fdevelopers.tosspayments.com%2Fsandbox%3Fapi-key-redirect%3Dmy'>내 API 키로 테스트하기</a>
